...
defmodule ApacheIcebergRESTCatalogAPI.Model.ReportMetricsRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: ApacheIcebergRESTCatalogAPI.Model.ReportMetricsRequest do
